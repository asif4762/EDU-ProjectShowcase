      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="grid grid-cols-2 md:grid-cols-4 lg:grid-cols-5 gap-8 lg:gap-12">
          ...
          <div className="col-span-2 lg:col-span-2">
            <motion.a href="#" className="flex items-center gap-2 text-foreground mb-4" whileHover={{ scale: 1.02 }}>
              <Gamepad2 className="w-8 h-8 text-primary" />
              <span className="text-xl font-bold">game.AI</span>
            </motion.a>
            <p className="text-muted-foreground text-sm leading-relaxed mb-6 max-w-xs">
              Your AI-powered board game coach. Learn faster, play smarter, enjoy more.
            </p>
        ...
        <div className="mt-12 pt-8 border-t border-border flex flex-col md:flex-row items-center justify-between gap-4">
          <p className="text-muted-foreground text-sm">© {new Date().getFullYear()} game.AI. All rights reserved.</p>
